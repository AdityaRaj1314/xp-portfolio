    ...
    <div className={styles.main}>
      <div className={styles.leftpanel}>
        <div className={styles.accordion}>
          ...
          <div style={{ backgroundColor: "#dde1ef", padding: "10px 15px", fontSize: "14px", border: "1px solid white", borderTop: "none" }}>
            <a 
              href={currDisplay.img.src} 
              download={currDisplay.title}
              style={{ textDecoration: "none", color: "#1f58ca", fontWeight: "600", display: "flex", alignItems: "center", gap: "8px" }}
            >
              💾 Save as
            </a>
          </div>
